...
{{< quiz id="kubernetes-observability-quiz" >}}
{
  "questions": [
    {
      "id": "kubernetes-observability-quiz-01",
      "type": "mcq",
    ...
    {
      "id": "kubernetes-observability-quiz-02",
      "type": "mcq",
    ...
    {
      "id": "kubernetes-observability-quiz-03",
      "type": "true-false",
    ...
    {
      "id": "kubernetes-observability-quiz-04",
    ...
    {
      "id": "kubernetes-observability-quiz-05",
      "type": "code-output",
    ...
    {
      "id": "kubernetes-observability-quiz-06",
      "type": "drag-drop",
    ...
    {
      "id": "kubernetes-observability-quiz-07",
      "type": "fill-blank",
    ...
    {
      "id": "kubernetes-observability-quiz-08",
      "type": "mcq",
    ...
    {
      "id": "kubernetes-observability-quiz-09",
      "type": "true-false",
    ...
    {
      "id": "kubernetes-observability-quiz-10",
    ...
    {
      "id": "kubernetes-observability-quiz-11",
      "type": "multiple-select",
    ...
    {
      "id": "kubernetes-observability-quiz-12",
      "type": "flashcard",
    ...
    {
      "id": "kubernetes-observability-quiz-13",
      "type": "mcq",
    ...
    {
      "id": "kubernetes-observability-quiz-14",
      "type": "code-output",
    ...
    {
      "id": "kubernetes-observability-quiz-15",
      "type": "true-false",
    ...
    {
      "id": "kubernetes-observability-quiz-16",
      "type": "fill-blank",
    ...
    {
      "id": "kubernetes-observability-quiz-17",
      "type": "multiple-select",
    ...
    {
      "id": "kubernetes-observability-quiz-18",
      "type": "flashcard",
    ...
    {
      "id": "kubernetes-observability-quiz-19",
      "type": "drag-drop",
    ...
    {
      "id": "kubernetes-observability-quiz-20",
      "type": "mcq",
    ...
    {
      "id": "kubernetes-observability-quiz-21",
      "type": "code-completion",
    ...
    {
      "id": "kubernetes-observability-quiz-22",
      "type": "true-false",
    ...
    {
      "id": "kubernetes-observability-quiz-23",
      "type": "mcq",
    ...
    {
      "id": "kubernetes-observability-quiz-24",
      "type": "flashcard",
